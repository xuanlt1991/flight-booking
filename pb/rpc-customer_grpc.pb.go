...
type CustomerServiceClient interface {
	...
	ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*CustomerResponse, error)
	ViewCustomer(ctx context.Context, in *ViewCustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error)
}
...
func (c *customerServiceClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*CustomerResponse, error) {
	out := new(CustomerResponse)
...
func (c *customerServiceClient) ViewCustomer(ctx context.Context, in *ViewCustomerRequest, opts ...grpc.CallOption) (*CustomerResponse, error) {
	out := new(CustomerResponse)
	err := c.cc.Invoke(ctx, "/proto.CustomerService/ViewCustomer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	ChangePassword(context.Context, *ChangePasswordRequest) (*CustomerResponse, error)
	ViewCustomer(context.Context, *ViewCustomerRequest) (*CustomerResponse, error)
...
func (UnimplementedCustomerServiceServer) ChangePassword(context.Context, *ChangePasswordRequest) (*CustomerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePassword not implemented")
}
func (UnimplementedCustomerServiceServer) ViewCustomer(context.Context, *ViewCustomerRequest) (*CustomerResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ViewCustomer not implemented")
}
...
func _CustomerService_ViewCustomer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ViewCustomerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomerServiceServer).ViewCustomer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.CustomerService/ViewCustomer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).ViewCustomer(ctx, req.(*ViewCustomerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CustomerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CustomerService_ViewCustomer_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc-customer.proto",
}
